...
class ProjectReportController extends Controller
{
    public function load(){
        ...
        $defaultVariablesArray = array(         // Speichert globale Variablen in Array
            ...
            'revenue_kuerue' => 5,              // Umsatz für Kündigungsrücknahme
            'revenue_hour_speedretention' => 35,// Umsatz pro Stunde auf Speedretention
    ...
    public function get1u1DslRetSum($defaultVariablesArray, $finalArray){
        ...
        $finalArray['sum']['dsl_kuerue'] = 0;
        $finalArray['sum']['optin_new_email'] = 0;
        $finalArray['sum']['optin_new_print'] = 0;
        $finalArray['sum']['optin_new_sms'] = 0;
        $finalArray['sum']['optin_new_call'] = 0;
        $finalArray['sum']['optin_new_usage'] = 0;
        $finalArray['sum']['optin_new_traffic'] = 0;
        $finalArray['sum']['optin_sum_payed'] = 0;
        ...
        $finalArray['sum']['hours_speedretention'] = 0;
        $finalArray['sum']['revenue_speedretention'] = 0;
        ...
        $finalArray['sum']['revenue_sales'] = 
            ...
            * $defaultVariablesArray['revenue_kuerue'];
    ...
    public function get1u1DslRetEmployees($defaultVariablesArray){
        ...
        foreach($employees as $key => $employee) {                                                      // Das MA-Array aus dem KDW Tool wird durchlaufen
            ...
            $refinedEmployees[$employeeArray['ds_id']]['revenue_sales'] =               // Hier werden alle Umsätze zusammengezählt
                ...
                * $defaultVariablesArray['revenue_kuerue'];                             // Multipliziert mit dem €-Wert für eine KüRü
            ...
            if(isset($refinedEmployees[$employeeArray['ds_id']]['person_id']) == true){
                ...
                $refinedEmployees[$employeeArray['ds_id']]['optin_sum_payed'] = 
                    $refinedEmployees[$employeeArray['ds_id']]['optin_new_email'] 
                    + $refinedEmployees[$employeeArray['ds_id']]['optin_new_print'] 
                    + $refinedEmployees[$employeeArray['ds_id']]['optin_new_sms']
                    + $refinedEmployees[$employeeArray['ds_id']]['optin_new_call']
                    + $refinedEmployees[$employeeArray['ds_id']]['optin_new_usage']
                    + $refinedEmployees[$employeeArray['ds_id']]['optin_new_traffic'];
            }
